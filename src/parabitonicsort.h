...
void Generate_local_list(size_t list_size, size_t local_list[], size_t local_index[]);
void Local_sort(size_t list_size, size_t local_keys[], size_t local_index[]);
int Key_compare(const size_t* p, const size_t* q);
int log_base2(int x);
void Par_bitonic_sort_incr(size_t list_size, size_t local_list[], size_t index_list[],
        int proc_set_size, int rank);
void Par_bitonic_sort_decr(size_t list_size, size_t local_list[], size_t index_list[],
        int proc_set_size, int rank);
